...
const styles = StyleSheet.create({
  ...
  summaryValue: { marginTop: 4, fontSize: 34, color: '#222832', fontWeight: '900' },
  ...
  currency: { fontSize: 17, color: '#F02D47', fontWeight: '800' },
  amount: { fontSize: 31, color: '#F02D47', fontWeight: '900' },
